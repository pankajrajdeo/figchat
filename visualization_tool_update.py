...
def get_dataset_metadata() -> str:
    ...
    # Check if PRELOADED_DATASET_INDEX is None or a DataFrame
    if PRELOADED_DATASET_INDEX is None or isinstance(PRELOADED_DATASET_INDEX, pd.DataFrame):
        # Use parse_tsv_data to load the metadata as a dictionary
